...
permute_=Permute((2,1),input_shape=(224,224))(lambda_)
...
dense_1 = Dense(64,activation='relu')(concat_)
output_ = Dense(31,activation='softmax')(dense_1)
...
model.save('jetson bidirectional gru batch 16 cross validation input shape 224,224,1 padding -1_augmentation_3x_5_by_20.h5')
