...
class MobileNetV2Custom(nn.Module):
    def __init__(self, num_classes=31):
        ...
        self.base_model.features[0][0] = nn.Conv2d(1, 32, kernel_size=3, stride=2, padding=1)
...
state_dict = torch.load(os.path.join(dataset_path, "mobilenetv2_model_only_on_training.pth"),
                        map_location=device)
